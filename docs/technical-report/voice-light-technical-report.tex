...
\begin{figure*}[t]
\centering
\includegraphics[width=0.83\textwidth]{../assets/voice-agent-interaction-policy-light.png}
\caption{Light-theme interaction diagnostics from the public browser client. Filled dots are actual
model observations; hollow marks indicate stale or inapplicable evidence. The speech lanes show
observed user activity and acknowledged assistant playback.}
\label{fig:debug}
\end{figure*}
...
Figure~\ref{fig:debug} shows the resulting browser view.

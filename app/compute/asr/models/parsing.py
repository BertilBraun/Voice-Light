...
def words_from_parakeet_timestamps(decoded_timestamps: object) -> list[TimestampedWord]:
    if (
...
def timestamp_pieces(raw_items: list[object]) -> list[TimestampedWord]:
...
def merge_timestamp_pieces(pieces: list[TimestampedWord]) -> list[TimestampedWord]:
    words: list[TimestampedWord] = []
    current_text = ""
...
def words_from_whisperx_output(aligned_output: object) -> list[TimestampedWord]:
...
def words_from_nemo_timestamps(
    timestamp_payloads: list[dict[str, JsonScalar]],
